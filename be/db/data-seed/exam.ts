...
const soalPPU: ujianSession = {
  ...
  questions: [
    ...
    { //Soal 9 //ERROR -Test
      txtField: "(1) Lonjakan harga cip memori di pasar global berimbas pada industri ponsel pintar tanah air.\n(2) Perusahaan riset pasar menaikkan proyeksi harga cip memori menjadi 90-95 persen pada triwulan pertama 2026.\n(3) Kenaikan ini dipicu oleh permintaan infrastruktur pusat data untuk menjalankan teknologi kecerdasan buatan.\n(4) Produsen semikonduktor lebih memprioritaskan memasok cip untuk pusat data yang memiliki margin keuntungan lebih tinggi.\n(5) Konsekuensinya, pasokan cip untuk ponsel pintar kelas bawah terus menurun.\n(6) Associate market analyst IDC Indonesia menyatakan, situasi ini bakal memburuk pada paruh kedua 2026.\n(7) Akibatnya, siklus beli ponsel baru di kalangan konsumen Indonesia diperkirakan bakal semakin panjang 1-2 tahun.",
...
`,
    ...
    { //Soal 15 //ERROR -Test
      txtField: "Dari himpunan {3, 5, 7, 9} akan diambil dua anggotanya sekaligus secara acak.\nPernyataan mana saja yang bernilai benar berdasarkan informasi di atas?\n(1) Peluang terambilnya dua bilangan dengan hasil kali genap adalah 1/2.\n(2) Peluang terambilnya dua bilangan dengan jumlah kurang dari 12 adalah 1/3.\n(3) Peluang terambilnya dua bilangan dengan selisih bilangan prima adalah 1/3.\n(4) Peluang terambilnya dua bilangan dengan hasil kali ganjil adalah 1.",
      question: "Pernyataan mana saja yang bernilai benar?",
      options: [
        "(1), (2), dan (3) SAJA",
        "(1) dan (3) SAJA",
