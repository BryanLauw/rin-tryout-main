...
\\begin{array}{|l|c|c|c|}
\\hline
\\textbf{Hari} & \\textbf{Kopi} & \\textbf{Teh} & \\textbf{Jus} \\\\
\\hline
\\text{Senin}   & 30 & 25 & 20 \\\\
\\hline
\\text{Selasa}  & 32 & 24 & 22 \\\\
...
$$
`,
      question: "Jika total pelamar selama lima tahun tersebut adalah 270 orang, jumlah pelamar pada tahun-tahun yang tidak melebihi 20% dari total pelamar adalah ... orang.",
    ...
    { //Soal 10 //ERROR -Test
      txtField: `Lima orang pedagang menjual dua jenis buah: mangga dan jeruk. Keuntungan jeruk adalah $$\\frac{1}{3}$$ dari keuntungan mangga. Berikut data penjualan masing-masing pedagang:
$$
\\begin{array}{|l|c|c|}
\\hline
\\textbf{Pedagang} & \\textbf{Mangga (kg)} & \\textbf{Jeruk (kg)} \\\\
\\hline
\\text{Ani}   & 40 & 80 \\\\
\\hline
\\text{Budi}  & 45 & 70 \\\\
...
\\end{array}
$$`,
      question: `Pedagang dengan keuntungan $$\\textbf{terbesar kedua}$$ adalah ...`,
...
const soalPPU: ujianSession = {
  ...
  questions: [
    { //Soal 1
      txtField: `(1) Peraturan Presiden Nomor 4 Tahun 2026 tentang Lahan Sawah Dilindungi diteken sebagai bentuk komitmen pemerintah menjaga kedaulatan pangan. (2) Regulasi ini bagaikan pisau bermata dua bagi industri properti. (3) Di satu sisi, kebijakan tersebut melindungi lahan pertanian produktif dari alih fungsi. (4) Di sisi lain, aturan ini berpotensi memperlebar $$\\textit{backlog}$$ perumahan yang mencapai jutaan unit. (5) Para pengembang menilai pemetaan lahan sawah dilindungi kerap hanya berdasarkan citra satelit, tanpa verifikasi di lapangan. (6) Akibatnya, lahan yang sebenarnya tidak lagi produktif ikut terkunci dan tidak bisa dimanfaatkan untuk pembangunan perumahan rakyat. (7) Kondisi ini memicu perdebatan sengit antara kementerian terkait dan asosiasi pengembang.`,
    ...
    { //Soal 2 //ERROR -Test
      txtField: `(1) Peraturan Presiden Nomor 4 Tahun 2026 tentang Lahan Sawah Dilindungi diteken sebagai bentuk komitmen pemerintah menjaga kedaulatan pangan. (2) Regulasi ini bagaikan pisau bermata dua bagi industri properti. (3) Di satu sisi, kebijakan tersebut melindungi lahan pertanian produktif dari alih fungsi. (4) Di sisi lain, aturan ini berpotensi memperlebar $$\\textit{backlog}$$ perumahan yang mencapai jutaan unit. (5) Para pengembang menilai pemetaan lahan sawah dilindungi kerap hanya berdasarkan citra satelit, tanpa verifikasi di lapangan. (6) Akibatnya, lahan yang sebenarnya tidak lagi produktif ikut terkunci dan tidak bisa dimanfaatkan untuk pembangunan perumahan rakyat. (7) Kondisi ini memicu perdebatan sengit antara kementerian terkait dan asosiasi pengembang.`,
      question: `Kata yang memiliki makna lebih luas dari kata $$\\textit{properti}$$ dalam kalimat (2) adalah ….`,
    ...
    { //Soal 6
      txtField: `(1) Pemerintah menargetkan pertumbuhan ekonomi Indonesia mencapai 8 persen dalam dua tahun ke depan. (2) Target ini disampaikan Menko Perekonomian Airlangga Hartarto dalam acara Indonesia Economic Outlook 2026. (3) Ia menganalogikan ekonomi seperti pesawat yang sejak 1998 selalu tertahan berbagai gangguan, namun kini siap lepas landas. (4) Mesin pertumbuhan akan terus digenjot melalui belanja pemerintah, investasi, serta Danantara sebagai $$\\textit{sovereign wealth fund}$$. (5) Dari sisi permintaan, konsumsi masyarakat dan ekspor menjadi penggerak utama. (6) Capaian ekonomi kuartal IV-2025 tumbuh 5,11 persen secara tahunan, menempatkan Indonesia di posisi kedua G20 setelah India. (7) Capaian ini ditopang konsumsi rumah tangga yang tumbuh 4,98 persen dan investasi 5,09 persen.`,
      question: `Frasa $$\\textit{menempatkan Indonesia di posisi kedua G20 setelah India$$ pada kalimat (6) dapat diperbaiki menjadi ….`,
      options: [
    ...
    { //Soal 7
      txtField: `(1) Pemerintah menargetkan pertumbuhan ekonomi Indonesia mencapai 8 persen dalam dua tahun ke depan. (2) Target ini disampaikan Menko Perekonomian Airlangga Hartarto dalam acara Indonesia Economic Outlook 2026. (3) Ia menganalogikan ekonomi seperti pesawat yang sejak 1998 selalu tertahan berbagai gangguan, namun kini siap lepas landas. (4) Mesin pertumbuhan akan terus digenjot melalui belanja pemerintah, investasi, serta Danantara sebagai $$\\textit{sovereign wealth fund}$$. (5) Dari sisi permintaan, konsumsi masyarakat dan ekspor menjadi penggerak utama. (6) Capaian ekonomi kuartal IV-2025 tumbuh 5,11 persen secara tahunan, menempatkan Indonesia di posisi kedua G20 setelah India. (7) Capaian ini ditopang konsumsi rumah tangga yang tumbuh 4,98 persen dan investasi 5,09 persen.`,
      question: `Kata $$\\textit{lepas landas}$$ pada kalimat (3) dalam bacaan tersebut paling dekat maknanya dengan kata ….`,
    ...
    { //Soal 17 //ERROR -Test
      txtField: "(1) Kebun Raya Itera di Lampung menjadi benteng pelestarian flora khas Sumatera. (2) Dua di antaranya adalah gaharu dan kantong semar yang kini langka di habitat aslinya. (3) Sebelum kebun raya hadir, kedua tanaman itu banyak diburu untuk diperdagangkan secara ilegal. (4) Kini, gaharu dan kantong semar mulai terawat dan dikembangbiakkan oleh para peneliti. (5) Gaharu hanya bisa tumbuh di dataran rendah, sedangkan kantong semar lebih adaptif di berbagai ketinggian. (6) Tidak jarang, pengunjung kebun raya baru pertama kali melihat langsung bentuk tanaman tersebut. (7) Kondisi ini menunjukkan betapa pentingnya peran kebun raya dalam edukasi konservasi.\n\n(8) Beberapa penelitian menunjukkan bahwa manfaat gaharu dan kantong semar tidak hanya sebagai tanaman hias. (9) Keduanya sama-sama berpotensi sebagai bahan obat tradisional. (10) Gaharu mengandung senyawa aromatik yang digunakan dalam industri wewangian dan (11) kantong semar dimanfaatkan sebagai obat mata.",
    ...
    { //Soal 20 //ERROR -Test
      txtField: "Nenek memasak nasi \"Sega kukus bumbung\".\nKakek menanam jagung \"Jagung tandur cangkul\".\nNasi dimasak Kakek \"Sega cangkul kukus\".",
...
const soalPBM: ujianSession = {
  ...
  questions: [
    { //Soal 1 //ERROR -Test
      txtField: `(1) Seekor gajah Sumatra ditemukan mati dalam kondisi mengenaskan tanpa kepala di area konsesi hutan tanaman industri di Kabupaten Pelalawan, Provinsi Riau. (2) Bangkai satwa dengan nama $$\\textit{Latin Elephas maximus sumatranus}$$ itu ditemukan pada 2 Februari 2026 di Distrik Ukui, Desa Lubuk Kembang Bunga, Kecamatan Ukui. (3) Kepala Balai Besar Konservasi Sumber Daya Alam (BBKSDA) Riau Supartono menegaskan bahwa kematian gajah tersebut merupakan peristiwa yang sangat serius. (4) Menurutnya kejahatan terhadap gajah sama dengan kejahatan terhadap negara dan masa depan keanekaragaman hayati Indonesia. (5) Hilangnya bagian kepala menjadi indikasi kuat adanya perburuan liar. (6) Gajah tersebut diduga diburu untuk diambil gadingnya.`,
      question: "Perbaikan kalimat (2) yang paling tepat sesuai kaidah penulisan istilah ilmiah dan tanda baca adalah ...",
      options: [
        `Bangkai satwa dengan nama Latin $$\\textit{Elephas maximus sumatranus}$$ itu ditemukan pada 2 Februari 2026 di Distrik Ukui, Desa Lubuk Kembang Bunga, Kecamatan Ukui.`,
        `Bangkai satwa dengan nama latin $$\\textit{Elephas maximus sumatranus}$$ itu ditemukan pada 2 Februari 2026, di Distrik Ukui, Desa Lubuk Kembang Bunga, Kecamatan Ukui.`,
    ...
    { //Soal 5 //ERROR -Test
      txtField: "(1) Kondisi tersebut menunjukkan bahwa literasi digital tidak cukup hanya diajarkan secara teoretis di sekolah.\n(2) Dalam beberapa tahun terakhir, penyebaran informasi palsu di media sosial meningkat secara signifikan.\n(3) Oleh karena itu, diperlukan kemampuan berpikir kritis agar masyarakat mampu memilah informasi sebelum membagikannya.\n(4) Banyak pengguna internet yang langsung menyebarkan berita tanpa memeriksa kebenarannya terlebih dahulu.\n(5) Pendidikan literasi digital yang aplikatif dan berkelanjutan menjadi salah satu solusi yang dapat diterapkan.",
    ...
    { //Soal 6 //ERROR -Test
      txtField: "(1) Menteri Pendidikan, Nadiem Makarim, menyampaikan bahwa penggunaan teknologi digital di sekolah perlu ditingkatkan secara merata. (2) Ia menjelaskan bahwa masih banyak sekolah di daerah terpencil yang belum memiliki akses internet yang memadai. (3) Selain itu, ketersediaan perangkat seperti laptop dan tablet juga masih terbatas sehingga proses pembelajaran digital belum berjalan optimal. (4) Pemerintah, menurutnya akan terus berupaya memperluas jaringan internet ke berbagai wilayah. (5) Upaya tersebut diharapkan dapat meningkatkan kualitas pembelajaran dan pemerataan pendidikan. (6) Jika infrastruktur digital semakin baik, maka kesenjangan pendidikan antar wilayah dapat dikurangi.",
    ...
    { //Soal 13 //ERROR -Test
      txtField: `(1) Bank sampah tidak hanya berfungsi sebagai tempat pengelolaan limbah, tetapi juga mampu meningkatkan perekonomian warga. (2) Salah satu wilayah yang berhasil mengembangkan program tersebut adalah $$\\textbf{Kampung Berseri}$$ di $$\\textbf{Surabaya, Jawa Timur.}$$ (3) Program ini mendorong masyarakat untuk memilah sampah sejak dari rumah tangga. (4) Sampah anorganik seperti plastik dan kertas dikumpulkan, ditimbang, lalu dicatat sebagai tabungan warga. (5) Selain itu, sampah organik diolah menjadi kompos yang dimanfaatkan untuk pertanian dan penghijauan lingkungan. (6) Kegiatan tersebut tidak hanya berdampak pada kebersihan lingkungan, tetapi juga memperkuat solidaritas $$\\textbf{Sosial}$$ antarwarga. (7) Bahkan, beberapa produk hasil $$\\textbf{daur ulang}$$ berhasil dipasarkan hingga ke luar $$\\textbf{kota}$$. (8) Keberhasilan ini menunjukkan bahwa pengelolaan sampah berbasis komunitas memiliki peluang besar untuk dikembangkan secara berkelanjutan. (9) Dengan dukungan pemerintah dan partisipasi aktif masyarakat, program bank sampah dapat menjadi solusi atas permasalahan lingkungan di perkotaan.`,
    ...
    { //Soal 14 //ERROR -Test
      txtField: `(1) Bank sampah tidak hanya berfungsi sebagai tempat pengelolaan limbah, tetapi juga mampu meningkatkan perekonomian warga. (2) Salah satu wilayah yang berhasil mengembangkan program tersebut adalah $$\\textbf{Kampung Berseri}$$ di $$\\textbf{Surabaya, Jawa Timur.}$$ (3) Program ini mendorong masyarakat untuk memilah sampah sejak dari rumah tangga. (4) Sampah anorganik seperti plastik dan kertas dikumpulkan, ditimbang, lalu dicatat sebagai tabungan warga. (5) Selain itu, sampah organik diolah menjadi kompos yang dimanfaatkan untuk pertanian dan penghijauan lingkungan. (6) Kegiatan tersebut tidak hanya berdampak pada kebersihan lingkungan, tetapi juga memperkuat solidaritas $$\\textbf{Sosial}$$ antarwarga. (7) Bahkan, beberapa produk hasil $$\\textbf{daur ulang}$$ berhasil dipasarkan hingga ke luar $$\\textbf{kota}$$. (8) Keberhasilan ini menunjukkan bahwa pengelolaan sampah berbasis komunitas memiliki peluang besar untuk dikembangkan secara berkelanjutan. (9) Dengan dukungan pemerintah dan partisipasi aktif masyarakat, program bank sampah dapat menjadi solusi atas permasalahan lingkungan di perkotaan.`,
      question: `Kalimat berikut perlu dimasukkan dalam bacaan tersebut.\n\n $$\\textit{Program ini juga membuka lapangan kerja baru bagi warga sekitar melalui pengelolaan dan pemasaran produk daur ulang.}$$ \n\nKalimat tersebut paling tepat ditempatkan setelah kalimat nomor …`,
      options: ["(2)", "(4)", "(5)", "(6)", "(8)"],
      answerIndex: [3]
    },
    { //Soal 15 //ERROR -Test
    ...
    { //Soal 17 //ERROR -Test
      txtField: `(1) Desa wisata menjadi salah satu strategi pemerintah dalam mendorong pemerataan ekonomi di berbagai daerah. (2) Program ini tidak hanya mengandalkan keindahan alam, tetapi juga potensi budaya dan kearifan lokal masyarakat secara $$\\textbf{menyeluruh}$$. (3) [...], pengelolaan desa wisata harus dilakukan secara profesional agar mampu bersaing di tingkat nasional maupun internasional secara $$\\textbf{optimal}$$. (4) Pemerintah melalui $$\\textbf{Kementerian Pariwisata dan Ekonomi Kreatif}$$ terus memberikan pendampingan kepada pengelola desa wisata. (5) Pendampingan tersebut meliputi pelatihan manajemen, pemasaran digital, serta peningkatan kualitas sumber daya manusia yang $$\\textbf{efisien}$$. (6) Dengan pengelolaan yang tepat, desa wisata dapat menjadi sumber pendapatan baru bagi warga sekitar. (7) Namun, keberhasilan program ini sangat bergantung pada partisipasi aktif masyarakat lokal. (8) Masyarakat tidak hanya berperan sebagai objek pembangunan, melainkan juga sebagai subjek yang terlibat dalam perencanaan dan pelaksanaan kegiatan wisata. (9) Hal lainnya yang juga perlu diperhatikan adalah aspek keberlanjutan lingkungan. (10) Dalam pengembangan desa wisata yang berhasil tidak akan terwujud tanpa adanya sinergi antara pemerintah dan masyarakat. (11) Konsistensi pengawasan dan evaluasi secara berkala sangat diperlukan demi menjaga kualitas layanan wisata tersebut.`,
...
const soalPK: ujianSession = {
  ...
  questions: [
    {
      txtField: "Dari angka-angka 2, 4, 7, dan 9, akan dibentuk dua bilangan puluhan dengan setiap angka tepat dipakai sekali.\nPernyataan mana saja yang bernilai benar berdasarkan informasi di atas?\n(1) Bilangan puluhan terkecil yang mungkin dibentuk merupakan bilangan genap.\n(2) Bilangan puluhan terbesar yang mungkin dibentuk merupakan bilangan ganjil.\n(3) Selisih terbesar yang mungkin dari dua bilangan puluhan tersebut adalah 73.\n(4) Jumlah terbesar yang mungkin dari dua bilangan puluhan tersebut adalah 117.",
    ...
    { //Soal 2 //ERROR -Test
      txtField: `Tujuh bilangan bulat positif, yaitu 6, 5, 8, a, 7, 5, dan 7, memiliki rata-rata $$6\\frac{1}{7}$$. Jika modus dari ketujuh bilangan tersebut ditambah rata-ratanya adalah 78b, maka nilai b sama dengan …`,
      question: "Nilai b sama dengan …",
      options: [`$$\\frac{1}{7}$$`, `$$\\frac{2}{7}$$`, `$$\\frac{3}{7}$$`, `$$\\frac{4}{7}$$`, `$$\\frac{5}{7}$$`],
      answerIndex: [0]
    },
    { //Soal 3
    ...
    { //Soal 8 //ERROR -Test
      imageUrl: `https://tan-sandye-90.tiiny.site/PK-8-10.svg`,
      txtField: "Pada segitiga ABC di atas, besar ∠ABC = 45° dan AC = 6. Titik D terletak pada sisi BC sehingga AD tegak lurus BC dan AD = BD.",
      question: "Besar ∠BAC = …",
...
`,
      ...
      { //Soal 14 //ERROR -Test
      txtField: `Diketahui matriks $$A = \\begin{pmatrix} a & b \\\\ c & d \\end{pmatrix} dan B = \\begin{pmatrix} 10 & 12 \\\\ 14 & 16 \\end{pmatrix}$$ memenuhi persamaan $$A \\begin{pmatrix} 2 & 3 \\\\ 1 & 1 \\end{pmatrix} = B$$ untuk suatu bilangan riil a, b, c, d. 
$$
\\begin{array}{|c|c|}
\\hline
\\textbf{P} & \\textbf{Q} \\\\
...
$$`,
    ...
    { //Soal 15 //ERROR -Test
      txtField: `Dari himpunan {3, 5, 7, 9} akan diambil dua anggotanya sekaligus secara acak.\nPernyataan mana saja yang bernilai benar berdasarkan informasi di atas?\n(1) Peluang terambilnya dua bilangan dengan hasil kali genap adalah $$\\frac{1}{2}$$.\n(2) Peluang terambilnya dua bilangan dengan jumlah kurang dari 12 adalah $$\\frac{1}{3}$$.\n(3) Peluang terambilnya dua bilangan dengan selisih bilangan prima adalah $$\\frac{1}{3}$$.\n(4) Peluang terambilnya dua bilangan dengan hasil kali ganjil adalah 1.`,
      question: "Pernyataan mana saja yang bernilai benar?",
      options: [
        "(1), (2), dan (3) SAJA",
        "(1) dan (3) SAJA",
    ...
    { //Soal 16 //ERROR -Test
      txtField: `Diketahui suatu fungsi $$m = f(a) = ka^2 + la + 1$$ dengan k dan l bilangan real. Input a = 2 menghasilkan m = 11 dan input a = 3 menghasilkan m = 19.\nPernyataan mana saja yang bernilai benar berdasarkan informasi di atas?\n(1) Nilai k = 2.\n(2) Nilai k + l = 4.\n(3) Input a = 4 menghasilkan m = 31.\n(4) Input a = 1 menghasilkan m = 5.`,
      question: "Pernyataan mana saja yang bernilai benar?",
      options: [
        "(1), (2), dan (3) SAJA",
        "(1) dan (3) SAJA",
    ...
    { //Soal 17
      txtField: "",
      question: `Hasil dari $$\\frac{a}{3} - \\frac{b}{2}$$ adalah ....`,
      options: [
        `$$\\frac{2a - b}{6}$$`,
        `$$\\frac{a + 4b}{6}$$`,
        `$$\\frac{4a - b}{6}$$`,
    ...
    { //Soal 18 //ERROR -Test
      txtField: "Fungsi f(x) dan g(x) = 2x + 3 memiliki komposisi fungsi (f ∘ g)(a) = 23, dengan a > 0. Berapakah nilai dari f(5)? Putuskan apakah pernyataan (1) dan (2) berikut cukup untuk menjawab pertanyaan tersebut.\n(1) Nilai g(a) = 7.\n(2) Fungsi f(x) = ax + 4.",
    ...
    { //Soal 19 //ERROR -Test
      imageUrl: `https://tan-sandye-90.tiiny.site/PK-19.svg`,
...
const soalLitdo: ujianSession = {
  ...
  questions: [
    { //Soal 1 //ERROR -Test
      txtField: `$$\\textbf{Sinyal Kimia Gas Etilen}$$\n\nPematangan buah yang kita saksikan sehari-hari adalah proses kimia yang unik, di mana gas berperan sebagai sinyal utama. Fenomena ini paling mudah dipahami ketika kita meletakkan $$\\textbf{Buah A}$$, yaitu buah yang sudah matang (misalnya apel atau pisang yang sudah kuning), di dekat $$\\textbf{Buah B}$$, yaitu buah yang masih mentah (misalnya alpukat atau mangga hijau). Buah A yang sudah matang secara alami melepaskan $$\\textbf{Gas Etilen}$$ ($$C_{22}H_{44}$$). Gas Etilen ini adalah hormon tumbuhan yang bersifat volatil, yang berarti ia mudah menguap dan menyebar ke seluruh udara di sekitarnya. Dengan menempatkan kedua buah ini dalam satu wadah tertutup, Etilen yang dilepaskan oleh Buah A akan terperangkap dan berdifusi, lalu mencapai permukaan Buah B.\n\nGas Etilen yang diserap oleh Buah B yang mentah akan bertindak sebagai $$\\textbf{pemicu sinyal}$$ yang sangat kuat. Begitu molekul Etilen terikat pada reseptor di sel Buah B, ia mengirimkan sinyal untuk mengaktifkan enzim-enzim khusus. Enzim-enzim ini kemudian memulai serangkaian reaksi kimia seperti memecah zat hijau (klorofil) sehingga buah berubah warna menjadi kuning atau merah, memecah $$\\textbf{pati}$$ menjadi $$\\textbf{gula}$$ (membuat buah menjadi manis), dan melarutkan $$\\textbf{pektin}$$ (zat yang membuat buah keras) sehingga buah menjadi lunak. Jadi, Buah A secara efektif \"memberi tahu\" Buah B bahwa sudah waktunya untuk matang, menyebabkan pematangan terjadi lebih cepat dan lebih seragam daripada buah mentah yang dibiarkan sendiri.`,
    ...
    { //Soal 8
      imageUrl: `https://salmon-neilla-57.tiiny.site/LBI-8-10FIX.svg`,
    ...
    { //Soal 22 //ERROR -Test
      txtField: `$$\\textbf{Selera dan Persepsi Rasa Makanan}$$\n\nSecara ilmiah, rasa yang kita kenali hanya terdiri dari lima jenis, yaitu asin, manis, asam, pahit, dan gurih (umami), sebagai representasi dari sinyal kimia spesifik yang tertangkap lidah, jelas James. N. Palmer, peneliti dari University of Pennsylvania. “Kita bukan hanya mengenali rasa dari suatu makanan, tapi kombinasi dari rasa tersebut dengan aromanya. Persepsi itu yang menjadikan pengalaman kita berbeda”, tambahnya. Hal ini dapat menyingkap misteri mengapa setiap orang punya selera yang berbeda terhadap makanan, meski punya sensor lidah yang sama.\n\nSaat kita mengunyah, makanan akan bercampur dengan enzim dalam ludah. Hal ini memungkinkan adanya kontak antara makanan dengan lidah, yang terdiri dari kumpulan tonjolan kecil bernama papila. Tonjolan ini memiliki sekitar 50 hingga 100 sensor pengecap, yang masing-masing dapat mengenali kelima rasa, mulai dari manis hingga gurih.\n\n“Manusia menggunakan lima rasa untuk mengenali molekul spesifik yang terkandung dalam makanan”, ujar Kathryn Medler, profesor dari University of Buffalo. “Kita menyukai makanan manis, asin, atau gurih, karena molekul yang memiliki rasa tersebut banyak diperlukan tubuh. Sebaliknya, kita cenderung menghindari makanan asam, sebagai indikator makanan yang mungkin sudah busuk, dan juga pahit, sebagai pengenal racun potensial bagi tubuh. Tapi yang menarik dari lidah adalah, kita bisa melatih preferensinya, sehingga beberapa orang malah menyukai rasa asam dan pahit pada makanan tertentu”, papar Medler.\n\nSelain rasa, proses mengunyah juga melepas molekul odoran yang menghasilkan aroma khas. Molekul ini akan mengalir melalui saluran nasofaring menuju bagian belakang hidung, sehingga hidung masih bekerja saat makanan berada di rongga mulut. Proses ini dikenal dengan istilah $$\\textit{retronasal olfaction}$$, yang dapat mempengaruhi persepsi di otak kita. Contohnya, saus siraman steak dan coklat memiliki tingkat kepahitan, keasaman, dan kemanisan yang mirip, tapi punya aroma yang berbeda sehingga kita mempersepsikannya sebagai rasa yang berbeda.\n\nSetelah mengenali perbedaan rasa dengan persepsi, kita menjadi lebih mudah memahami bagaimana pengaruh DNA terhadap alasan mengapa kita menyukai dan membenci makanan tertentu. Gen kita menentukan bagaimana cara kita membentuk persepsi pada otak, bukan rasa yang dikenali lidah.\n\nDaun ketumbar segar, misalnya, memiliki aroma asam mirip jeruk akibat senyawa aldehid yang dikandungnya. Namun karena adanya variasi pada gen reseptor pada hidung kita, beberapa orang dapat lebih sensitif terhadap aldehid tersebut, sehingga mengunyah daun ketumbar terasa seperti memakan sabun. Fenomena ini terjadi karena aroma aldehid yang terlepas saat daun tergerus menginvasi sensor oversensitif di hidung.`,
      question: `Bagaimana proses $$\\textit{retronasal olfaction}$$ mempengaruhi selera manusia?`,
      options: [
...
const soalLitBing: ujianSession = {
  ...
  questions: [
    ...
    { //Soal 2 //ERROR -Test
      txtField: `$$\\textbf{Text A}$$\n\nPlastic packaging presents a major problem for both the environment and human health. Most plastics are made from fossil fuels and are not biodegradable. $$\\textbf{They}$$ can remain in landfills and oceans for hundreds of years, breaking down into tiny pieces known as microplastics. These microplastics pollute water, enter the food chain, and harm marine life through ingestion and entanglement. In addition, some plastics release harmful chemicals that can disrupt hormones or even cause cancer, especially when heated. Plastic production also depends on fossil fuels, which contributes to global warming and resource depletion.\n\nTo overcome these problems, scientists have turned to seaweed as a promising raw material for bioplastics. Seaweed is an abundant and fast- growing marine plant that requires no land, fertilizer, or freshwater to cultivate. It absorbs carbon dioxide as it grows, making it environmentally beneficial. Seaweed contains natural polysaccharides such as agar, carrageenan, and alginate that can be processed into flexible, transparent, and biodegradable films for food packaging. Some types of seaweed even have natural antimicrobial properties that can help prevent bacterial growth on food surfaces.\n\nDespite its potential, seaweed- based bioplastic still faces challenges. Production costs remain high, and the resulting materials are often less durable and water- resistant than petroleum- based plastics. Researchers are now developing better processing techniques to improve quality and lower costs. With continuous innovation, seaweed bioplastics could become a sustainable alternative for future food packaging.\n\n$$\\textbf{Text B}$$\n\nSeaweed is a marine algae found in coastal waters around the world, and it is attracting growing interest because of its versatility and renewability. It has been applied in food and nutrition and is used as an ingredient in soups, snacks, and health- foods.\n\nIn the cosmetics and pharmaceuticals sectors, seaweed extracts and polysaccharides (such as agar and carrageenan) function as thickeners, stabilisers and active bio- compounds with antioxidant or antimicrobial features.\n\nFurthermore, seaweed is increasingly used in agriculture and sustainable industry: as bio- fertilisers and biostimulants to improve soil health, and in the production of bioplastics and packaging materials that decompose naturally without leaving harmful microplastics.\n\nBecause seaweed cultivation needs no arable land and minimal fresh water, it offers a low- impact alternative to traditional farming. With continued research and investment, seaweed is positioned to become a key raw material in the transition to a more sustainable, circular economy.`,
      question: `The word $$\\textit{they}$$ in Text A paragraph 1 refers to....`,
      options: [
        "Fossil fuels",
        "Harmful chemicals",
        "Microplastics",
    ...
    { //Soal 17 //ERROR
      imageUrl: `https://salmon-neilla-57.tiiny.site/LBE-17-20fix.svg`,
    ...
    { //Soal 19 //ERROR
      imageUrl: `https://salmon-neilla-57.tiiny.site/LBE-17-20fix.svg`,
      txtField: "As the COVID-19 pandemic forced thousands of Duke University employees to work remotely, a survey revealed that a clear majority would prefer continuing to work away from campus even when the health threat subsides. Specifically, of about 2,200 staff and faculty surveyed, 74% indicated they would like to work three to five days per week off-site. Many employees rated the elimination of the daily commute, increased flexibility and perceived higher productivity as the top benefits. However, challenges remain, most notably, establishing effective boundaries between work and personal life.\n\nIn response to these findings, Duke created a 25-member Work-From-Home Committee tasked with shaping post-pandemic work strategy. The committee emphasised that remote-work policies must accommodate the very diverse roles within the institution, some functions cannot be fulfilled from home, such as lab work, front-line healthcare or hands-on instruction. According to leadership, returning exclusively to the office is not the only option; hybrid models are likely, allowing teams to decide at the department level how often employees should be on-site. The university also noted that telecommuting aligns with Duke's climate goals, fewer daily car trips could help reduce carbon emissions and work toward a target of climate neutrality.\n\nAlthough remote work at Duke appears to have entered a new normal, the transition is by no means complete. Departments are encouraged to test pilots, gather data and refine their approach over time. As one administrator put it, \"there is no one-size-fits-all approach here.\" Ultimately, Duke's future work-landscape will balance flexibility, productivity and institutional culture as employees and the university adapt to a changed world of work.",
      question: `$$\\textit{Suppose Duke decided to make remote work mandatory for all employees.}$$ \n\nBased on the text, which problem would most likely arise?`,
      options: [
...
const soalPM: ujianSession = {
  ...
  questions: [
    ...
    { //Soal 2 //ERROR -Test
      ...
      options: [`$$\\frac{1}{364}$$`, `$$\\frac{55}{1092}$$`, `$$\\frac{33}{182}$$`, `$$\\frac{5}{16}$$`, `$$\\frac{11}{16}$$`],
      answerIndex: [2]
    },
    { //Soal 3
      txtField: "Keluarga Langlangbhumi adalah salah satu keluarga yang telah ada sejak jaman Kerajaan Majapahit. Pada tahun 2025, keluarga besar Langlangbhumi terdiri dari 5 golongan tua dan 11 keluarga golongan muda. Setiap caturwulan, Keluarga Langlangbhumi mengadakan arisan. Untuk persiapan arisan, Keluarga Langlangbhumi mengadakan rapat keluarga dengan setiap keluarga diwakili oleh satu orang. Pada rapat tersebut akan dipilih panitia arisan yang terdiri dari ketua, bendahara, dan sekretaris. Pemilihan dilakukan secara acak.",
    ...
    { //Soal 4
      ...
      options: [`$$\\frac{11}{48}$$`, `$$\\frac{11}{40}$$`, `$$\\frac{11}{32}$$`, `$$\\frac{11}{24}$$`, `$$\\frac{11}{16}$$`],
      answerIndex: [3]
    },
    { //Soal 5 //ERROR
      imageUrl: `https://salmon-neilla-57.tiiny.site/PM-5-8-FIX.svg`,
      ...
      question: `Jika $$K_{n}$$ menyatakan barisan dari banyak bulir pada kolom A dimulai dari A1 hingga A8, maka $$K_{n}$$ = ….`,
      options: [`$$n + 8, n = 1, 2, 3,…, 8$$`, `$$n, n = 1, 2, 3,…, 8$$`, `$$9n, n = 1, 2, 3,…, 8$$`, `$$8n – 8, n = 1, 2, 3,…, 8$$`, `$$4n^2 – 3, n = 1, 2, 3,…, 8$$`],
      answerIndex: [3]
    },
    { //Soal 6 //ERROR
      type: "MULTIPLE_SELECTION",
    ...
    { //Soal 9 //ERROR
      imageUrl: `https://tan-sandye-90.tiiny.site/image-1.svg`,
    ...
    { //Soal 13
      imageUrl: `https://salmon-neilla-57.tiiny.site/PM-13-16-FIX.svg`,
    ...
    { //Soal 16
      ...
      imageUrl: `https://salmon-neilla-57.tiiny.site/PM-13-16-FIX.svg`,
      txtField: "Terdapat sebuah hotel yang baru saja dibuka dan pertama kali akan menerima tamu di hari Senin. Jumlah tamu yang masuk di awal hari dan keluar di akhir hari dicatat dan disajikan dalam diagram mingguan berikut.",
      question: `Staf hotel akan merasa kewalahan jika tamu yang masuk melebihi rata-rata mingguan ditambah $$\\frac{1}{4}$$ simpangan mutlak. Diasumsikan jumlah tamu yang masuk dan keluar tiap minggu masih memiliki pola yang sama. Pilihlah semua hari staf hotel merasa kewalahan dari pilihan-pilihan berikut!*`,
      options: ["Senin", "Selasa", "Rabu", "Kamis", "Jumat"],
      answerIndex: [0, 3]
    },
    { //Soal 17
